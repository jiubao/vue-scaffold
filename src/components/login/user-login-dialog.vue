<template>
  <div class="-user-login-dialog-container">
    <van-popup v-model="value" :overlay="true" :show-cancel-button="true">
      <div class="dialog-content">
        ...
        <div class="hander-btn-contetn flex f-34">
          <button class="left c-c1" @click.stop="cancleHander">取消</button>
          <button class="right c-t4" :disabled="disableLogin" :class="!disableLogin?'confirm-enable':'confirm-disable'" @click.stop="userLogin">登录</button>
        </div>
      </div>
    </van-popup>
  </div>
